...
1. [Starting](./docs/01 Starting kubernetes.md)
2. [Setup cert-manager](./docs/02 Setup cert manager.md)
3. [Setup service mesh](./docs/03 Setup service mesh.md)
4. [Setup logging](./docs/04 Setup logging.md)
5. [Setup monitoring](./docs/05 Setup monitoring.md)
